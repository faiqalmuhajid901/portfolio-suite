...
it(
    'serves the application liveness endpoint',
    function (): void {
        $this->get('/up')
            ->assertOk();
    }
...
it(
    'serves the database health endpoint',
    function (): void {
        $this->get('/health')
            ->assertOk()
            ->assertJson([
...
it(
    'only exposes public profile records',
    function (): void {
...
it(
    'only exposes completed projects',
    function (): void {
